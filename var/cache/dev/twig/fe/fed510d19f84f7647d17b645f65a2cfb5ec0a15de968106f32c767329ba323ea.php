...
class __TwigTemplate_501f870d40f5935304bfdbf038f6ac4a2e018d6cae2306e1e4f92707b0927309 extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    <div class=\"row\">
        ...
        if ((isset($context["users"]) || array_key_exists("users", $context))) {
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["user"]) {
                ...
                echo "\" class=\"btn-success promote-user\">
                                Assign Admin
                            </button>
                        </td>
                    ";
...
";
    ...
    public function block_javascripts($context, array $blocks = [])
    {
        ...
        // line 33
        echo "    <script src=\"/js/promoteUser.js\" data-route=\"";
        echo $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("admin_assing_users_rols");
        echo "\"></script>
";
    ...
    {
        return array (  138 => 33,  128 => 32,  114 => 26,  110 => 24,  99 => 19,  94 => 17,  90 => 16,  87 => 15,  82 => 14,  80 => 13,  69 => 4,  59 => 3,  36 => 1,);
    }
        ...
        <table class=\"table\">
            ...
            {% if users is defined %}
                    {% for user in users %}
                        ...
                        <td>{{ user.username }}</td>
                        <td>
                            <button type=\"button\" data-id=\"{{ user.id }}\" class=\"btn-success promote-user\">
                                Assign Admin
                            </button>
                        </td>
                    {% endfor %}
...
{% block javascripts %}
    <script src=\"/js/promoteUser.js\" data-route=\"{{ path('admin_assing_users_rols') }}\"></script>
{% endblock %}", "admin/user/index.html.twig", "/home/yaroslav/var/www/shop.ll/templates/admin/user/index.html.twig");
    }
}
