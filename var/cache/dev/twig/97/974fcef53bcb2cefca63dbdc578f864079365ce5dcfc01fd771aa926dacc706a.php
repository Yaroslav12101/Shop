...
class __TwigTemplate_9db48bb339ff8e67a49df2ba1d5ac2f35fb94c9a9a3369ae7a3d89107aa153ed extends Template
{
    private $source;
    private $macros = [];
...
{% block body %}
    <div class=\"row\">
        <a href=\"{{ path('admin_add_product') }}\">Add new product</a>
        <a href=\"{{ path('admin_add_category') }}\">Add new category</a>
    </div>
{% endblock %}", "admin/dashboard/index.html.twig", "/home/yaroslav/var/www/shop.ll/templates/admin/dashboard/index.html.twig");
    }
}
