...
/* home/view.html.twig */
class __TwigTemplate_442dcc779bed9138f42dd5496ee227ae0b920ad4bf31ef112af906b15979c32b extends Template
{
    private $source;
    private $macros = [];
    ...
    <div>";
        // line 6
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["product"]) || array_key_exists("product", $context) ? $context["product"] : (function () { throw new RuntimeError('Variable "product" does not exist.', 6, $this->source); })()), "description", [], "any", false, false, false, 6), "html", null, true);
        echo "</div>
    <div>";
        // line 7
